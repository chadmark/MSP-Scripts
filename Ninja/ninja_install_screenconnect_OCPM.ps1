...
.NOTES
    ...
    GitHub      : https://github.com/chadmark/MSP-Scripts/blob/main/Ninja/ninja_install_screenconnect_OCPM.ps1
...
if (-Not $IsInstalled) {
    ...
    $URL           = "https://markleytech.screenconnect.com/Bin/ScreenConnect.ClientSetup.exe?e=Access&y=Guest&c=OCPM&c=&c=&c=&c=&c=&c=&c="
