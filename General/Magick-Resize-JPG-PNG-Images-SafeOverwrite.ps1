...
.NOTES
    ...
    GitHub      : https://github.com/chadmark/MSP-Scripts/blob/main/General/Magick-Resize-JPG-PNG-Images-SafeOverwrite.ps1
    Environment : Windows 10/11
    Requires    : PowerShell 5.1+, ImageMagick (magick.exe in system PATH)
    Version     : 1.0 (draft — pending test; not yet in repo/changelog)
.LINK
